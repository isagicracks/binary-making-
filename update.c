...
// Encrypt aur Decrypt ke liye OpenSSL ka use kar sakte ho
...
int port;
int duration;
char padding_data[16 * 1024 * 1024]; // Increased padding for better memory alignment
...
void check_expiration() {
    ...
    if (remaining_time <= 0) {
        printf(RED "🔥 ===========================\n");
        printf("🔥 FILE CLOSED BY @SLAYER_OP7 🔥\n");
        printf("🚀 DM TO BUY NEW FILE @SLAYER_OP7 🚀\n");
        printf("🔥 ===========================\n" RESET);
        exit(EXIT_FAILURE);
    } else {
...
if (argc != 5) {
    fprintf(stderr, RED "🔥═══════════════════════════════════════════🔥\n");
    fprintf(stderr, CYAN "🚀           LAND KE PAPA ISAGI             🚀\n");
    fprintf(stderr, RED "🔥═══════════════════════════════════════════🔥\n" RESET);
